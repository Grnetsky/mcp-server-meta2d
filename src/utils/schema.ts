...
export const basePenSchema = z.object({
    ...
    text: z.string().optional().describe("Text to display on the square center"),
    color: z.string().optional().describe("Color of the square in hex format"),
    background: z.string().optional().describe("Background color of the square"),
    // 完善其他的schema属性
})
